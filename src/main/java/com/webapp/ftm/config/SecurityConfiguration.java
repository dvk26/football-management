...
import static com.webapp.ftm.utility.mapper.SecurityUtil.JWT_ALGORITHM;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
            ...
            throws Exception {
        String[] whiteList={"/", "api/v1/auth/login","api/v1/auth/register", "api/v1/auth/refresh","/storage/**"
        };
